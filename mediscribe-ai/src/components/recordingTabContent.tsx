...
export const RecordingTabContent = ({
  isRecording,
  recordedBlob,
  isTransitioning,
  startRecording,
      ...
      {!isRecording && !recordedBlob ? (
        ...
        <div className="flex flex-col items-center space-y-8">
          <div className="relative">
            ...
            <div
              className="absolute -inset-8 rounded-full bg-red-500/10 animate-pulse"
              style={{ animationDelay: '0.5s' }}
            ></div>
            <div
              className="absolute -inset-12 rounded-full bg-red-500/5 animate-pulse"
          ...
          <div className="text-center">
            <p
              className={`text-5xl font-bold bg-gradient-to-r ${GRADIENT_RECORDING} bg-clip-text text-transparent`}
            >
        ...
        <div className="text-center space-y-6 py-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button
              ...
              variant="outline"
              className="gap-2 rounded-full px-6 border-2 cursor-pointer"
            >
